r"""ShadowUnveilMore - Classical Shadow with Extended Trace Methods of BitWise
(:mod:`qurrium_pqp.qurries.classical_shadow_more`)
...
from .qurry import ShadowUnveilMore, SUMeasureArgs
